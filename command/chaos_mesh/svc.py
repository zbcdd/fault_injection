...
class SvcHttpRequestDelay(ChaosMeshCommand):
    def __init__(self, tmp_dir, app, port, time, duration, interval, namespace):
        ...
        self.fault_type = 'svc-http-request-delay'
    ...
    def __str__(self):
        return f'[svc-http-request-delay] app: {self.app} port: {self.port} ' \
...
class SvcHttpRequestAbort(ChaosMeshCommand):
    def __init__(self, tmp_dir, app, port, duration, interval, namespace):
        ...
        self.fault_type = 'svc-http-request-abort'
        self.tmp_dir = tmp_dir
        self.app = app
        self.port = port
        self.namespace = namespace
    ...
    def __str__(self):
        return f'[svc-http-request-abort] app: {self.app} port: {self.port} namespace: {self.namespace}'
